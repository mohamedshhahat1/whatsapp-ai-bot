        ...
        SliverToBoxAdapter(
          child: Padding(padding: const EdgeInsets.all(16), child: Column(children: [
            ...
            Card(child: ListTile(
              ...
              trailing: DropdownButton<ThemeMode>(value: themeMode, underline: const SizedBox(), onChanged: (mode) { if (mode != null) ref.read(themeModeProvider.notifier).set(mode); }, items: const [
            ...
            Card(child: ListTile(
              ...
              trailing: DropdownButton<Locale>(value: locale, underline: const SizedBox(), onChanged: (loc) { if (loc != null) ref.read(localeProvider.notifier).set(loc); }, items: const [
