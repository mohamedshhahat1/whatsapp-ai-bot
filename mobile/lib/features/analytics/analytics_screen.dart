        ...
        child: Column(
          ...
          children: [
            ...
            ...questions.asMap().entries.map((entry) {
              ...
              return ListTile(dense: true, contentPadding: EdgeInsets.zero, leading: CircleAvatar(radius: 14, backgroundColor: AppColors.primary.withValues(alpha: 0.1), child: Text('${i + 1}', style: const TextStyle(fontSize: 12, color: AppColors.primary, fontWeight: FontWeight.w600))), title: Text(q.question, maxLines: 2, overflow: TextOverflow.ellipsis), subtitle: Text('${q.count} times · ${Formatters.chatTime(q.lastAsked)}'));
            }),
          ],
        ),
      ),
